...
export default function Footer() {
    return (
        <footer className="bg-[#0056A0] text-white py-6 sm:py-8"> {/* Footer background and padding */}
                    ...
                    <div className="flex flex-col items-center space-y-6 text-center">
                        <div className="w-full lg:w-2/3 space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <p>Rodrigo Sáez <br /> Mecánico Jefe</p>
                                </div>
                                <div>
                                    <p>Cesar Chavarría <br /> Asesor Comercial</p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                <Link
                                    ...
                                    className="flex items-center justify-center space-x-4 text-white hover:text-gray-300 transition"
                                >
